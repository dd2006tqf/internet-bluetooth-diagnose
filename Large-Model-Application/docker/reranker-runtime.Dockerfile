...
LABEL org.opencontainers.image.title="industrial-ops-reranker-runtime" \
...
RUN groupadd --system --gid 10001 app \
    ...
    && mkdir -p /app /mnt/models/reranker \
    && chown -R app:app /app /mnt/models/reranker

WORKDIR /app
USER app
ENTRYPOINT ["industrial-ops-reranker-runtime"]
