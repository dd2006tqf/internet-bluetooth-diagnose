...
LABEL org.opencontainers.image.title="industrial-ops-rul-runtime" \
...
RUN groupadd --system --gid 10001 app \
    ...
    && mkdir -p /app /mnt/models/rul \
    && chown -R app:app /app /mnt/models/rul

WORKDIR /app
USER app
ENTRYPOINT ["industrial-ops-rul-runtime"]
