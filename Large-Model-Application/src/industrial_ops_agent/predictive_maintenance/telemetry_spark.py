"""PySpark executor for the shared telemetry sequence contract."""
...
from industrial_ops_agent.predictive_maintenance.dataset_contract import prepare_rows


def build_telemetry_spark_snapshot(
    ...
    *,
    ...
    session = spark or (
        SparkSession.builder.appName("industrial-ops-telemetry-curation")
